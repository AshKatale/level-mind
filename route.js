...
other input which is based on query give json file format who display in given data in bar chart, pie chart, graph. use object array whenever needed. Don't add the space between the keys in key pair value`;
