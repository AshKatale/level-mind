...
const TeamMemberCard = ({ name, role, description, imageUrl, socialLinks }) => {
  return (
  ...
  const teamMembers = [
    {
      ...
      imageUrl: "/prathamesh.png", // Ensure this is in the /public folder
      socialLinks: {
    ...
    },
    {
      ...
      imageUrl: "/ashutosh.png", // Ensure this is in the /public folder
      socialLinks: {
        linkedin: "https://linkedin.com",
        github: "https://github.com",
        instagram: "https://instagram.com",
    ...
    },
    {
      ...
      imageUrl: "/sarthak.png", // Ensure this is in the /public folder
      socialLinks: {
        linkedin: "https://linkedin.com",
        github: "https://github.com",
        instagram: "https://instagram.com",
    ...
    },
    {
      ...
      imageUrl: "/ghanshyam.png", // Ensure this is in the /public folder
      socialLinks: {
        linkedin: "https://linkedin.com",
        github: "https://github.com",
        instagram: "https://instagram.com",
